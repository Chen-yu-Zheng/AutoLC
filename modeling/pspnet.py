...
import modeling.backbone.resnet as resnets
...
class PSPNet(nn.Module):
    def __init__(self, layers=50, bins=(1, 2, 3, 6), dropout=0.1, classes=2, zoom_factor=8, use_ppm=True, pretrained=False):
...
if __name__ == '__main__':
    input = torch.rand(4, 3, 32, 32).cuda()
