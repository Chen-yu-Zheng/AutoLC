...
def obtain_search_args():
    ...
    parser.add_argument('--dataset', type=str, default='loveda',
                        choices=['pascal', 'coco', 'cityscapes', 'kd', 'loveda', 'floodnet'],
    ...
    parser.add_argument('--arch_lr', type=float, default=3e-3, metavar='LR',
    ...
    parser.add_argument('--dist', default=False,
                        type=bool, help='whether use distrbuted train')
